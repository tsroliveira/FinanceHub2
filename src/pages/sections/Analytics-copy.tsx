  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-900 rounded-xl p-6 border border-border/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white">Total de Análises</p>
              <p className="text-2xl font-bold text-white">{analises.length}</p>
            </div>
        ...
        <div className="bg-blue-900 rounded-xl p-6 border border-border/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white">Rentabilidade Média</p>
        ...
        <div className="bg-blue-900 rounded-xl p-6 border border-border/50">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white">Alto Risco</p>
              <p className="text-2xl font-bold text-white">
                {analises.filter((a) => a.risco === "Alto").length}
              </p>
            </div>
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
              ...
              <tbody>
                {filteredAnalises.map((analise) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-foreground">{analise.empresa}</td>
